...
<br></br># Project Components ## Implemented Modules - Arithmetic-Logic Unit (ALU) - Datapath (Uses the
'registers' and ALU to logic) - CPU (Interface for datapath, state machine, memory, and I/O) - Shifter
(Shifts data by a given amount) - Register File (Emulates registers in a CPU) - State Machine (Controls
instruction decode and datapath) - Instruction Decoder (Decodes instructions)
