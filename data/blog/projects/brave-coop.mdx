...
tags: ['project', 'work', 'hardware', 'software', 'C++', 'AWS', 'bluetooth', 'cloud', 'embedded']
draft: false
summary: 'My 2022 summer co-op at Brave Technology Cooperative. '
layout: PostLayout
---

# Co-op at Brave Technology Cooperative
...
[**Repo**](https://github.com/bravetechnologycoop/BraveSensor)\
...
[**Repo**](https://github.com/bravetechnologycoop/LoraBraveSensor)
...
The old provisioning process required a lot of manual labour, by using the sh\*tty tools provided by the manufacturer of our LoRaWAN buttons to update the firmware settings to our liking. There was also a bit of overhead in getting the EUI from the device, and adding it to our AWS IoT Core for LoRaWAN. My solution to this was to create an [Autohotkey](https://www.autohotkey.com/) to do all of the tasks on the computer automatically. The only point humans had to intervene was to connect/disconnect the buttons, and to press the button to enter the firmware update mode. Overall, this significantly improved our efficiency in provisioning the buttons.
