...
Key-Scheduling Algorithm (KSA) - ARC4 Pseudo-Random Generation Algorithm (PRGA) - ARC4 Cracker
(tocrack encrypted text) - Concurrent ARC4 Cracker (using two modifier cracker modules)
