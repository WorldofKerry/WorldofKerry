...
<br></br># Project Components ## Implemented Modules - ARC4 State Initilization (to setup memory) - Key-Scheduling
Algorithm (KSA) - ARC4 Pseudo-Random Generation Algorithm (PRGA) - ARC4 Cracker (tocrack encrypted text)
